...
public class StupidFooBarQixorAcceptanceTest extends AcceptanceTest {

	public StupidFooBarQixorAcceptanceTest(int input, String expected, String description) {
